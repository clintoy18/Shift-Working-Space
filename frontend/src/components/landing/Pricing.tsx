  ...
  const meetingRooms = [
    {
      ...
      originalPrice: "190",
      price: "175",
      details: ["Cubicles with loft", "Open time only"],
    ...
    },
    {
      ...
      originalPrice: "290",
      price: "270",
      details: ["Huddle rooms 1 & 2", "Open time only"],
      amenities: commonAmenities,
      icon: Users,
    },
    {
      ...
      originalPrice: "480",
      price: "420",
      details: ["Conference room", "Open time only"],
      amenities: commonAmenities,
      icon: Users,
    },
  ];
    ...
    >
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-20">
          <Badge
            variant="outline"
            className="mb-4 border-primary text-primary px-4 py-1"
          >
            ...
            >
              ...
              >
                ...
                <CardHeader className="text-center pt-10">
                  ...
                  <p className="text-sm text-primary font-medium mt-1 uppercase">
                    {plan.period}
                  </p>
                </CardHeader>
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {meetingRooms.map((item, i) => (
              ...
              >
                <Card className="relative flex flex-col border-2 border-border hover:border-primary/50 transition-all duration-300 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-muted/40 p-8 md:p-12 rounded-[2rem] border border-border">
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-muted-foreground text-sm">
              Be a member now and claim these exclusive weekly and monthly rates
              when you walk in.
            </p>
            <div className="flex flex-wrap gap-2">
              ...
              <Badge className="bg-primary/10 text-primary border-none italic tracking-tighter">
                Snacks for Sale
              </Badge>
            </div>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-4">
              <p className="text-xs font-bold text-yellow-900 uppercase tracking-tight">
                ⏰ Limited Time Offer
              </p>
              <p className="text-xs text-yellow-800 mt-1">
                Discounted prices <b>EXCLUSIVE ONLY</b> for memberships made
                during March 1 to March 31
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-background p-6 rounded-2xl border border-border relative overflow-hidden group">
              ...
              <h4 className="text-xs font-black text-primary uppercase mb-6 tracking-widest">
                Platinum (Weekly)
              </h4>
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-4">
                  <p className="text-[10px] font-bold text-blue-900 uppercase tracking-tight mb-2">
                    Meeting Room Access
                  </p>
                ...
                <p className="text-[10px] text-muted-foreground mt-2 italic font-medium leading-none">
                  *Cubicle subject to availability
                </p>
              </div>
            </div>
            ...
            <div className="bg-background p-6 rounded-2xl border-2 border-primary relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-3 opacity-5">
                <Badge className="text-[40px] font-black italic text-primary">
                  M
                </Badge>
              </div>
              <h4 className="text-xs font-black text-primary uppercase mb-6 tracking-widest">
